...
DELETE FROM accounts WHERE accounts.id = $1 RETURNING id, owner, balance, currency, created_at
`
...
SELECT id, owner, balance, currency, created_at FROM accounts WHERE accounts.id = $1 LIMIT 1
`
...
SELECT id, owner, balance, currency, created_at FROM accounts WHERE accounts.id = $1 LIMIT 1 FOR NO KEY UPDATE
`
...
UPDATE accounts SET balance = $2 WHERE accounts.id = $1 RETURNING id, owner, balance, currency, created_at
`
