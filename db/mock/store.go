...
// Source: github.com/gricowijaya/go-transaction/db/sqlc (interfaces: Store)
...
func (m *MockStore) UpdateEntries(arg0 context.Context, arg1 db.UpdateEntriesParams) (db.Entries, error) {
	m.ctrl.T.Helper()
